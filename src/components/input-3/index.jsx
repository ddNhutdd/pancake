...
const Input3 = forwardRef((props, ref) => {
    ...
    const [showPassword, setShowPassword] = useState(type === input3Type.password);
    ...
    return (
        <div className={css.inputContainer}>
            <div className={css.input}>
                ...
                <div className={`${css.input__eye} ${renderClassShowEyeWithType()} `}>
                    <Button2 onClick={handleShowPassword} type={button2Type.outlineSmall}>
