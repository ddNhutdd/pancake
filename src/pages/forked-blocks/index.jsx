...
function ForkedBlocks() {
	...
	return (
		<div className={css.forkedBlocks}>
			<div className={css.container}>
				<HeaderComponent2
					mainContent={
						<div className='flex items-center gap-2'>
							Forked Blocks
							<span className={css.forkedBlocks__headerComponent}>
								Excluded blocks as a result of &quot;Chain
								Reorganizations&quot;
							</span>
						</div>
					}
				/>
				<Card className={css.forkedBlocks__card}>
					<Table
