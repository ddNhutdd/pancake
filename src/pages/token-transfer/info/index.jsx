...
function Info() {
	return (
		<div className={css.info}>
			<div className={css.header}>Additional Info</div>
			<div className={css.info__record}>
				<div className={css.info__title}>Status:</div>
				<div>
			...
			<div className={css.info__record}>
				<div className={css.info__title}>Transaction Action:</div>
				<div>
					<div>
			...
			<div className={css.info__line}></div>
			<div className={css.info__record}>
				<div className={css.info__title}>Transaction Fee:</div>
				<div>
			...
			<div className={css.info__line}></div>
			<div className={css.info__record}>
				<div className={css.info__title}>Gas Info:</div>
				<div>
			...
			<div className={css.info__line}></div>
			<div className={css.info__record}>
				<div className={css.info__title}>Nonce:</div>
				<div>
					<span>18</span>
			...
			<div className={`${css.info__last} ${`--text-gray`}`}>
				<span className='--text-blue'>See more details</span>
				<MdArrowOutward />
			</div>
		</div>
	);
