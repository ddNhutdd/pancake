...
function NftTrades() {
					...
					<div className={css.nftTrades__items__right}>
						...
						<Popover
							...
							content={
								<>
									<span>
										0x90c5bb6da247e0384d640ed3e61c848e0e83e3d0005158a812b98ff9587b0fb4
									</span>
	...
	const listSearchDropdown = [
		...
		},
		{
			id: 2,
			content: (
				<div className={`${css.nftTrades__dropdownSearchItem}`}>
					<img
						src={cake}
						alt='cake'
					/>
	...
	const [dropdownSearchSelected, setDropdownSearchSelected] = useState(
		listSearchDropdown[0].content.props.children.at(-1),
	);
				...
				<Card className={css.nftTrades__card}>
					<div className={css.nftTrades__header}>
						<div
							...
							className={css.nftTrades__left}
						>
							<Dropdown2
								header={
									<Button2
										classname={css.nftTrades__card__button}
						...
						<div className={css.nftTrades__right}>
							<Input3 placeholder={`Search by token address`} />
							<span className={css.nftTrades__right__icon}>
								<IoIosSearch />
							</span>
						</div>
					</div>
