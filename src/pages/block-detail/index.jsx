...
const Block = function () {
	...
	const [fetchRewardStatus, setFetchRewardStatus] = useState(
		apiStatus.pending,
	);

	const renderClassShowFetching = () =>
				...
				<div className={css.block__content}>
					...
					<Card className={css.block__card}>
								...
								<Popover
									...
									content={
										<div className='flex flex-col'>
											<span>
												Also known as Block Number. The
												block height,
											</span>
											<span>
												which indicates the length of
												the blockchain,
											</span>
											<span>
												increases after the addition of
												the new block.
											</span>
										</div>
									}
								...
								<Popover
									...
									content={
										<div className='flex flex-col'>
											...
											<span>
												transaction is transactions as a
												result of contract
											</span>
											<span>
												execution that involves BNB
												value
											</span>
										</div>
									}
							...
							<div className={css.block__left}>
								<Popover
									...
									content={
										<div className='flex flex-col'>
											<span>
												Validator who successfully
												included the block
											</span>
											<span>onto the blockchain.</span>
										</div>
									}
									className={css.block__question}
								>
							...
							<div className={css.block__left}>
								<Popover
									...
									content={
										<div className='flex flex-col'>
											<span>
												For each block, the miner is
												rewarded with a finite
											</span>
											<span>
												amount of BNB on top of the fees
												paid for all
											</span>
											<span>
								...
								<Popover
									...
									content={
										<div className='flex flex-col'>
											...
											<span>
												block. The difficulty algorithm
												may adjust
											</span>
											<span>according to time.</span>
										</div>
									}
									className={css.block__question}
								>
							...
							<div className={css.block__left}>
								<Popover
									...
									content={
										<div className={`flex flex-col`}>
											<span>
												The block size is actually
												determined by the
											</span>
											<span>block's gas limit.</span>
										</div>
									}
									className={css.block__question}
								>
								...
								<Popover
									...
									content={
										<div className={`flex flex-col`}>
											...
											<span>
												percentage of gas filled in the
												block.
											</span>
										</div>
									}
							...
							<div className={css.block__left}>
								<Popover
									...
									content={
										<div className={`flex flex-col`}>
											<span>
												Total gas limit provided by all
												transactions in the
											</span>
											<span>block.</span>
										</div>
						...
						<div className={css.block__cardRecord}>
							<div className={css.block__left}>
								<Popover
									placement={popoverPlacementType.top}
									trigger={popoverTriggerType.hover}
									content={`Fees burnt by this block.`}
									className={css.block__question}
								>
									<CiCircleQuestion />
								</Popover>
						...
						<div className={css.block__cardRecord}>
							...
							<div className={css.block__right}>
								<Card className={css.block__right__card}>
									{mainData?.extraData}
								</Card>
							</div>
						</div>
					...
					<CardCollapse
						...
						footer={
							<div className={css.block__cardCollapseRecord}>
								...
								<div
									className={`${css.block__right} --text-blue`}
								>
									<div
								...
								<div className={css.block__left}>
									<Popover
										...
										content={
											<div className='flex flex-col'>
												<span>
													The hash of the block from
													which this block was
												</span>
												<span>
													generated, also known as its
													parent block.
												</span>
											</div>
										}
		...
		<div className={css.block}>
			<div className={css.container}>
				<HeaderComponent2
					mainContent={
						<div>
							Block
							<span
								className={`--text-gray ${css.block__header}`}
							>
								#{blocknumber}
							</span>
						</div>
				...
				<div className={css.block__footer}>
					...
					hashes. Any tampering of a block would invalidate all
					following blocks as all subsequent hashes would change.
