...
function PasswordRecovery() {
    ...
    return (
        <div
            className={css.passwordRecovery}
        >
            <div
            ...
            >
                ...
                <Card
                    className={css.passwordRecovery__card}
                >
                    <form onSubmit={submitHandle}>
                        <div
                            className={css.passwordRecovery__header}
                        >
                            Password Recovery
                        </div>
                        <div
                            className={css.passwordRecovery__headerSmall}
                        >
                        ...
                        <Input3
                            ...
                            regular={[regular.email, commonString.formatInvalid]}
