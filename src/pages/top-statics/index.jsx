...
function TopStatics() {
    ...
    const listItem = [
        {
            ...
            headerRight: <span className='--text-blue'>
                View Top 20
            </span>,
            rows: [
                {
                    ...
                    rightTop: `Total BNB`,
                    rightBot: <div className='flex gap-1 items-center justify-end justify-sm-start'>
                        <img src={bnb} alt="bnb" />
                ...
                },
                {
                    ...
                    rightTop: `Total Txn`,
                    rightBot: <span className='--text-gray'>
                        150,016.08805193
                    </span>
                },
                {
                    ...
                    rightTop: <div className='flex gap-1 items-center justify-end justify-sm-start'>
                        <SiGoogledocs />
                        <span className='--text-blue'>BUSD-T Stablecoin</span>
                    </div>,
                    rightBot: <div className='flex gap-1 items-center justify-end justify-sm-start'>
                        <img src={bnb} alt="bnb" />
                        <div className='--text-gray'>150,016.08805193</div>
            ...
            rows: [
                {
                    ...
                    leftBot: <Popover
                        ...
                        <div className='flex gap-1 items-center'>
                            <img src={bnb} alt="bnb" />
                            <div className='--text-gray'>Binance: Hot Wallet 6</div>
                        </div>
                    </Popover>,
                    rightTop: `Total BNB`,
                    rightBot: <div className='flex gap-1 items-center justify-end justify-sm-start'>
            ...
            rows: [
                {
                    ...
                    rightTop: `Total BNB`,
                    rightBot: <div className='--text-gray'>150,016.08805193</div>
                },
                {
                    leftTop: `Top BNB Sender`,
                    leftBot: <Popover
    ...
    const renderlistItem = () => listItem.map(item => (<div key={item.id} className={`col-6 col-lg-12`}>
                ...
                <Card>
                    <div className={`row`}>
                        <div className={`col-6 col-sm-12`}>
                            <ListTabs list={listTime} selectedItem={selectedTime} setSelectedItem={setSelectedTime} />
                        </div>
                        <div className={`col-6 text-right col-sm-12 text-sm-left`}>
                            24 Mar - 25 Mar
                        </div>
                        {renderlistItem()}
                    </div>
