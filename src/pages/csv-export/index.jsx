...
function CsvExport() {
	...
	const [dropdownTypeSelected, setDropdownTypeSelected] = useState(
		dropdownTypeList[0],
	);
			...
			<HeaderComponent4
				...
				content={
					<>
						...
						<span className={css['headerComponent4--bold']}>
							{' '}
							please verify that you are not a robot
						</span>{' '}
						by completing the captcha below.
					</>
				}
			/>
			<Card className={css.csvExport}>
				<div className={css.csvExport__cardBody}>
					<div className={css.csvExport__input}>
						<div className={css.csvExport__label}>
							Select export type
						</div>
						<Popover
					...
					<div className={css.csvExport__input}>
						<div className='flex items-center gap-2 mb-2'>
							<Switch2
								...
								setActive={setIsNote}
							/>
							<span>Tick to include txn privates note</span>
						</div>
						<div className=' flex items-center gap-2 mb-2'>
							<Switch2
								active={isNameTag}
							...
							/>
							<span>Tick to include txn privates name tag</span>
						</div>
					</div>
					<div className='flex items-center gap-1'>
						<CiCircleQuestion />
						The earliest 5,000 records within the selected range
						will be exported
					</div>
				</div>
				<div className={`border-t-1 ${css.csvExport__cardFooter}`}>
					...
					<Button2
						...
						classname={css.csvExport__reset}
					>
						Reset
					</Button2>
				</div>
