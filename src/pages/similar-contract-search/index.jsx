...
function SimilarContractSearch() {
    ...
    const chainsList = [
        {
            id: 1,
            content: <CheckBox onChange={chainItemChangeHandle} id={`Etherum`} text={`Etherum`}></CheckBox>
        },
        {
            id: 2,
            content: <CheckBox onChange={chainItemChangeHandle} id={`BTC`} text={`BTC`}></CheckBox>
        },
        {
            id: 3,
            content: <CheckBox onChange={chainItemChangeHandle} id={`USDT`} text={`USDT`}></CheckBox>
        }
    ]

    const [similarDropdownShow, setSimilarDropdownShow] = useState(false);
    const [similarDropdownSelected, setSimilarDropdownSelected] = useState(similarList[0])
                        ...
                        <div className='row'>
                            ...
                            <div className='col-3 col-lg-12 pl-lg-0'>
                                <Dropdown2
                                    ...
                                    header={<div
                                        className={css.similarContractsSearch__dropdownHeader}
