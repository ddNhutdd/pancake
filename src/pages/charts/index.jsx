	...
	return (
		<div className={css.chart}>
			<div className={css.container}>
				<HeaderComponent2
					mainContent={`BNB Smart Chain Charts & Statistics`}
				/>
				<div className='row mb-3 pt-5'>
					<div className='col-3 d-md-0'>
						<ul
							ref={menuElementRef}
							className={`${css.chart__menu} ${renderClassStick()}`}
						>
							<li>
								<NavLink
									onClick={scrollToMarkbook.bind(
										null,
										'chart__record__market',
									)}
								>
									Market Data
								</NavLink>
					...
					<div className='col-9 col-md-12 border-l-1 border-l-md-0'>
						<div
							id='chart__record__market'
							data-section={`section`}
							className={`row mb-3  border-b-1  ${css.chart__record}`}
						>
							<div
								className={`col-12 mb-3 p-0 ${css.chart__header}`}
							>
								Market Data
							</div>
