                ...
                <div className={css.accountBalanceChecker__body}>
                    <div className={css.accountBalanceChecker__input}>
                        ...
                        <Dropdown2
                            ...
                            header={
                                <div
                                    className={css.accountBalanceChecker__dropdownOptionHeader}
                    ...
                    <div className={css.accountBalanceChecker__input}>
                        <div className={css.accountBalanceChecker__label}>Account Address / Contract Address <span className='--text-danger'>*</span></div>
                        <Input3 />
                    </div>
                    <div className={css.accountBalanceChecker__input}>
                        <div className={css.accountBalanceChecker__label}>Filter by:</div>
                    ...
                    <div className={css.accountBalanceChecker__input}>
                        <div className={css.accountBalanceChecker__label}>Date for the snapshot</div>
                        <DateInput2 format={dateFormat} placeholder={dateFormat} />
                    </div>
                    <div className={css.accountBalanceChecker__input}>
                        <div className={css.accountBalanceChecker__label}>Date for the snapshot</div>
