...
function SectionButtonInfo(props) {
	...
	return (
		<div>
			<span className={`${css.sectionButtonInfo}`}>
				<div
					onClick={toggleInfoClickHandle}
					className={`${css.sectionButtonInfo__show} ${renderHideInfo()}`}
				>
					<span>Info</span>
					<span>
						<FaAngleDown />
				...
				<div
					onClick={toggleInfoClickHandle}
					className={`${css.sectionButtonInfo__show} ${renderShowInfo()}`}
				>
					<span>Hide</span>
					<span>
						<FaAngleUp />
