...
function Staking() {
    ...
    const list = [
        {
            ...
            token: 'CAKE',
            periods: [[30, 1.2, 1], [60, 1.3, 1.1], [90, 1.4, 1.3]],
            aprMin: '0.11',
            aprMax: '0.19',
            total: '40167.3',
    ...
    const renderMainData = () => {
        return isShowType === actionType.grid ? <GridCards list={list} /> : <ListItems list={list} />
    }
            ...
            <div className={css.staking__content}>
                <div className={css.staking__content__container}>
                    <div className={css.staking__content__actions}>
                        <span onClick={actionClickHandle.bind(null, actionType.grid)} className={`${renderClassActiveAction(actionType.grid)}`}>
                            <BsFillGrid3X2GapFill />
                        </span>
                        <span onClick={actionClickHandle.bind(null, actionType.list)} className={`${renderClassActiveAction(actionType.list)}`}>
                            <FaList />
                        </span>
                    </div>
