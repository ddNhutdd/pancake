          ...
          <div className={`${css.home5__mainContent}`}>
            <div className={`${css.home5__left}`}>
              <div className={`${css.home5__leftRecord}`}>
                <div className={`${css.home5__leftRecord__text}`}>
                  Community Members
                </div>
                <div className={`${css.home5__leftRecord__number}`}>2.0M +</div>
              </div>
              <div className={`${css.home5__leftRecord}`}>
                <div className={`${css.home5__leftRecord__text}`}>
                  Multilingual Communities
                </div>
                <div className={`${css.home5__leftRecord__number}`}>15 +</div>
              </div>
              <div className={`${css.home5__leftRecord}`}>
                <div className={`${css.home5__leftRecord__text}`}>
                  Community Ambassadors
                </div>
                <div className={`${css.home5__leftRecord__number}`}>35 +</div>
              </div>
            </div>
            <div className={`${css.home5__right}`}>
              ...
              >
                <div className={`${css.home5__right__slide1__header}`}>
                  Top Tweet of the week
                </div>
                <div className={`${css.home5__right__slide1__image}`}>
                  <img src="src/assets/imgs/pancakeswap-logo.png" alt="logo" />
                </div>
                <div className={`${css.home5__right__slide1__title}`}>
                  PancakeSwap🥞Ev3ryone's Favourite D3X
                </div>
                <div className={`${css.home5__right__slide1__info}`}>
                  <div className={`${css.home5__right__slide1__info__item}`}>
                    @PancakeSwap
                  </div>
                  <div className={`${css.home5__right__line}`}></div>
                  <div className={`${css.home5__right__slide1__info__item}`}>
                    Feb 7
                  </div>
                  <div className={`${css.home5__right__line}`}></div>
                ...
                <div className={`${css.home5__right__slide1__text}`}>
                  🐲 Step into the Dragon Lunar Lottery at PancakeSwap! Chase a
                  treasure of 16,000 CAKE & an additional $3,880 in USDT prizes!
                  ✨ 🧧 Join the celebration:
                  https://app.questn.com/event/869387113325449247
                </div>
                <NavLink className={`${css.home5__right__slide1__nav}`}>
                  Web link
                  <CiShare1 />
                </NavLink>
              </div>
              ...
              >
                <div className={`${css.home5__right__slide2__header}`}>
                  Latest Blog Post
                </div>
                <div className={`${css.home5__right__slide2__img}`}></div>
                <div className={`${css.home5__right__slide2__data}`}>
                  2024-03-01
                </div>
                <div className={`${css.home5__right__slide2__text}`}>
                  Unlock 10% Trading Fee Rebate: Join the First-Ever Trading
                  Reward Program for veCAKE Holders!
                </div>
              </div>
