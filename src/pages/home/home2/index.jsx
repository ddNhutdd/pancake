	...
	const listMarkquee = [
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/baseicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/bnbicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/aptosicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/polygonicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/zksyncicon.png'
							alt='base'
						/>
					}
				/>
		...
		},
		{
			...
			content: (
				<MarqueeItem
					...
					icon={
						<img
							src='src/assets/imgs/lineaicon.png'
							alt='base'
						/>
					}
				/>
	...
	return (
		<div className={`${css['home2']} ${renderDarkTheme()}`}>
			...
			<div className={`${css['home2__imageLeft']}`}>
				<img
					src='src/assets/imgs/image-11.png'
					alt='left'
				/>
			</div>
			<div className={`${css['home2__imageRight']}`}>
				<img
					src='src/assets/imgs/image-12.png'
					alt='right'
				/>
			</div>
			<div
