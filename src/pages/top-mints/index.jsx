    ...
    const listRecord = [
        {
            ...
            cols: [
                `1`
                ,
                <div key={`1-1`} className={`flex items-center gap-1`}>
                    <Popover
                    ...
                    <Popover
                        ...
                        content={<div className='flex items-center flex-col justify-center p-0'>
                            <span>Repulic NEUTRAL: Some infomation on this token has</span>
                            <span>been verified by BcsScan. Click for more info</span>
                        </div>}
                    >
                        <HiOutlineCheckBadge />
                    </Popover>
