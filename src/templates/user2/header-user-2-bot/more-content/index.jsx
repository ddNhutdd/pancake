		...
		<div className={css.moreContent}>
			<div className={css.moreContent__item}>
				...
				<div className={`${css.moreContent__record} ${css.text}`}>
					Discover more of BscScan&apos;s tools and services in one
					place.
				</div>
			</div>
			<div className={css.moreContent__item}>
				...
				<div
					onClick={redirectPage.bind(null, url.unitConverter)}
					data-header={`header`}
					className={css.moreContent__record}
				>
					<AiOutlineSync />
					Unit Converter
				</div>
				<div
					onClick={redirectPage.bind(null, url.csvExport)}
					data-header={`header`}
					className={css.moreContent__record}
				>
					<BsDownload />
				...
				<div
					onClick={redirectPage.bind(null, url.accountBalanceChecker)}
					data-header={`header`}
					className={css.moreContent__record}
				>
					<BiMoneyWithdraw />
