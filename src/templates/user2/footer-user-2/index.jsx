		...
		<div className={css.footer}>
			<div className={css.container}>
				<div className={css.footer__top}>
					...
					<div
						onClick={scrollToTop}
						className={css.footer__top__item}
					>
						<BiArrowToTop />
						Back To Top
					</div>
				...
				<div className={css.footer__mid}>
					<div className={css.footer__mid__item}>
						...
						<div className={css.footer__mid__row}>
							BscScan is a Block Explorer and Analytics Platform
							for BNB Smart Chain.
						</div>
						<div className={css.footer__mid__row}>
					...
					<div className={css.footer__mid__item}>
						...
						<NavLink
							to={'#'}
							className={css.footer__mid__row}
						>
							Delegate to BscScan
							<Pill>Stacking</Pill>
						</NavLink>
				...
				<div className={css.footer__bot}>
					<div className={css.footer__bot__item}>
						BscScan © 2024 (BSC-D) | ⛏ Built by Team{' '}
						<span className={css['footer__bot--blue']}>
							Etherscan
						</span>{' '}
						<span className={css.footer__bot__icon}>
							<CiShare1 />
						</span>
					</div>
					<div className={css.footer__bot__item}>
						...
						<span
							className={`${css.footer__bot__icon} ${css['footer__bot--red']}`}
						>
							<FaHeart />
						</span>
					</div>
